...
public class RegisterUserValidator : AbstractValidator<RequestUserJson>
{
    public RegisterUserValidator()
    {
        ...
        When(request => string.IsNullOrWhiteSpace(request.Password) == false, () =>
        {
            RuleFor(request => request.Password.Length).GreaterThanOrEqualTo(6).WithMessage("A senha precisa ser conter pelo menos 6 caracteres.");
        });
    }
}
